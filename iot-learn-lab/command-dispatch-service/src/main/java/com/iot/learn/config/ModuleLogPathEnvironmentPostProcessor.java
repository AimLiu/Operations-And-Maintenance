 ...
 *   <li>{@code iot-learn-lab/command-dispatch-service/log}（从仓库根目录启动）</li>
 *   <li>{@code command-dispatch-service/log}（从 iot-learn-lab 目录启动）</li>
 *   <li>{@code ./log}（已在模块目录内启动）</li>
 * </ol>
 */
public class ModuleLogPathEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {

    private static final String MODULE_NAME = "command-dispatch-service";
