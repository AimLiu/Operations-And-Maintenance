 ...
 *   <li>{@code iot-learn-lab/device-report-consumer/log}（从仓库根目录启动）</li>
 *   <li>{@code device-report-consumer/log}（从 iot-learn-lab 目录启动）</li>
 *   <li>{@code ./log}（已在模块目录内启动）</li>
 * </ol>
 */
public class ModuleLogPathEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {

    private static final String MODULE_NAME = "device-report-consumer";
