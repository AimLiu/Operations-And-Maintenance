...
**实施计划：** `docs/superpowers/plans/2026-07-16-stage2-w3-ingress-prometheus.md`  
**前置指南：** `docs/superpowers/guides/2026-07-16-stage2-w3-ingress-prometheus.md`
...
**实施计划：** `docs/superpowers/plans/2026-07-17-stage2-w4-helm-chart.md`  
**前置指南：** `docs/superpowers/guides/2026-07-17-stage2-w4-helm-primer.md`
...
**实施计划：** `docs/superpowers/plans/2026-07-19-stage2-w5-helm-values.md`  
**前置指南：** `docs/superpowers/guides/2026-07-19-stage2-w5-helm-values.md`
...
| 产出 | `infra/argocd/application-iot-learn-lab.yaml`；`scenario-k6-argocd-sync.sh` |

**实施计划：** `docs/superpowers/plans/2026-07-21-stage2-w6-argocd.md`  
**前置指南：** `docs/superpowers/guides/2026-07-21-stage2-w6-argocd.md`
...
| 产出 | `scripts/stage2/scenario-k7-rollouts-canary.sh` |

**实施计划：** `docs/superpowers/plans/2026-07-22-stage2-w7-rollouts.md`  
**前置指南：** `docs/superpowers/guides/2026-07-22-stage2-w7-rollouts.md`
...
| 部署 | Jaeger all-in-one（**优先 WSL Docker**，与 Prometheus 同属混合可观测；亦可 Helm/manifest） |
| 实验 | `POST /reports` 全链路；Feign + Kafka consumer span |
| 产出 | `docs/stage2-tracing-runbook.md`；`scenario-k8-jaeger-trace.sh` |

**实施计划：** `docs/superpowers/plans/2026-07-23-stage2-w8-jaeger.md`  
**前置指南：** `docs/superpowers/guides/2026-07-23-stage2-w8-jaeger.md`
...
│   ├── scenario-k4-helm-baseline.sh         # W4
│   ├── scenario-k5-helm-values-switch.sh    # W5
│   ├── scenario-k6-argocd-sync.sh           # W6
│   └── scenario-k7-rollouts-canary.sh       # W7
└── docs/
    ├── stage2-interview-notes.md
    ├── stage2-helm-cheatsheet.md            # W5
...
├── plans/2026-07-16-stage2-w3-ingress-prometheus.md
├── plans/2026-07-17-stage2-w4-helm-chart.md
├── plans/2026-07-19-stage2-w5-helm-values.md
├── plans/2026-07-21-stage2-w6-argocd.md
...
| 2026-07-16 | 补充 W3 实施计划与 Ingress / NodePort / Prometheus 前置指南链接 |
| 2026-07-17 | 补充 W4 Helm Chart 实施计划与前置指南；Rollouts 场景脚本顺延为 k5 |
| 2026-07-19 | 补充 W5 Values/checksum/canary 计划与指南；Rollouts 场景脚本再顺延为 k6 |
